...
public class BackofficeCockpitUserServiceTest
{
	...
	public void testIsAdmin()
	{
		...
		Mockito.when(userService.getAllUserGroupsForUser(user)).thenReturn(Collections.singleton(adminGroup));
		Mockito.when(adminGroup.getUid()).thenReturn(BackofficeCockpitUserService.BACKOFFICE_ADMIN_GROUP);
