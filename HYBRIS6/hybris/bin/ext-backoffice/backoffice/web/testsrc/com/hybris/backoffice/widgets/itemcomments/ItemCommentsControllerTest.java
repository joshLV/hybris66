...
public class ItemCommentsControllerTest extends AbstractWidgetUnitTest<ItemCommentsController>
{
	...
	@Mock
	private TypedSettingsMap typedSettingsMap;
	...
	public void shouldAddNewCommentWhenOkButtonIsClicked() throws Exception
	{
		...
		when(itemCommentsController.getWidgetSettings()).thenReturn(typedSettingsMap);
		when(typedSettingsMap.getString(SETTING_DEFAULT_COMMENTS_COMMENT_TYPE)).thenReturn(BACKOFFICE_COMMENT);
