...
/**
 * Spock service layer specification
 * Code from {@link de.hybris.platform.servicelayer.ServicelayerTest}
 */
@Ignore
//CHECKSTYLE:OFF
@SuppressWarnings("PMD")
class YSpockServicelayerSpec extends YSpockServicelayerBaseSpec
{
    ...
    protected boolean isPrefetchModeNone()
    {
        ...
        return ServicelayerConstants.VALUE_PREFETCH_NONE.equals(config) || ServicelayerConstants.VALUE_PREFETCH_DEFAULT.equals(config);
    }
}
//CHECKSTYLE:ON