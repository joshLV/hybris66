...
/**
 * Base class fro spock service layer specification
 * Code from {@link de.hybris.platform.servicelayer.ServicelayerBaseTest}
 */
@Ignore
//CHECKSTYLE:OFF
@SuppressWarnings("PMD")
class YSpockServicelayerBaseSpec extends YSpockSpecification{
