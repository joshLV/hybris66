		...
		<td valign="bottom">	
			<table>
				...
				<tr>
					...
					<td><%=HMCHelper.xssEncodeHTML(JaloSession.hasCurrentSession()?JaloSession.getCurrentSession().getSessionContext().getLocale().getDisplayName(JaloSession.getCurrentSession().getSessionContext().getLocale())+" - "+JaloSession.getCurrentSession().getSessionContext().getLocale():"n/a")%></td>
				</tr>
				<tr>
