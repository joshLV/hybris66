...
public class ProfileLoyaltyStatisticPopulator<SOURCE extends NeighbourData, TARGET extends ProfileLoyaltyStatisticData>
		implements Populator<SOURCE, TARGET>
{
	...
	public void populate(final SOURCE neighbourData, final TARGET loyalty) throws ConversionException
	{
		...
		loyalty.setActivityScore(neighbourProperties.get(YaasyprofileconnectConstants.Loyalty.ACTIVITY_SCORE));
	}
}
