...
public class NumericCheckerImpl implements CsticValueValidator
{
	...
	private static final String MSG_KEY_NOT_NUMERIC_ERROR = "sapproductconfig.value.too.long.fraction";
	...
	public String validate(final CsticData cstic, final Errors errorObj, final String value)
	{
		...
		{
			createFieldError(cstic, value, errorObj, args, NOT_A_NUMBER, MSG_KEY_NOT_NUMERIC_ERROR);
			return value;
		}
