...
public class CharacteristicPopulatorTest
{
	...
	@Test
	public void testPopulateValuesSetParent()
	{
		final CPSValue cloudEngineValue = source.getValues().get(0);
		cloudEngineValue.setParentCharacteristic(null);
		classUnderTest.populateValues(source, target);
		assertNotNull(cloudEngineValue);
		assertEquals(source, cloudEngineValue.getParentCharacteristic());
	}
	...
	{
		final CPSPossibleValue cloudEnginePossibleValue = source.getPossibleValues().get(0);
		cloudEnginePossibleValue.setParentCharacteristic(null);
		classUnderTest.populatePossibleValues(source, target);
