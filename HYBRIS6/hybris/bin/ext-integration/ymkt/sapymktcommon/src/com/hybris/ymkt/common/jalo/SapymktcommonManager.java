...
public class SapymktcommonManager extends GeneratedSapymktcommonManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(SapymktcommonManager.class);
	 ...
	 */
	public SapymktcommonManager() // NOPMD
	{
		LOG.debug("constructor of SapymktcommonManager called.");
	}
