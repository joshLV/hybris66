...
public class UserContextService
{
	...
	/**
	 * Provide the {@link CustomerModel#getOriginalUid()} if user is an instance of CustomerModel.<br>
	 * {@link UserModel#getUid()} otherwise.
	 *
	 * @param user
	 *           {@link UserModel} to check and extract {@link CustomerModel#getOriginalUid()} from.
