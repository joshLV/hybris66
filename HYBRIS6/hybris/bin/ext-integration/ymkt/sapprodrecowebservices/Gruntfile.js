...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        ngdocs: {
            options: {
                dest: 'jsTarget/docs',
                title: "sapprodrecowebservices API",
                startPage: '/#/sapprodrecowebservices',
            },
            sapprodrecowebservices: {
                api: true,
                src: ['web/features/common/**/*.js', 'web/features/sapprodrecowebservices/**/*.js'],
                title: 'sapprodrecowebservices'
            }
        },
        watch: {
            test: {
