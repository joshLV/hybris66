...
public class CampaignRestrictionEvaluator implements CMSRestrictionEvaluator<CMSYmktCampaignRestrictionModel>
{
	...
	private static final String SESSION_PREFIX = "ymktSegmentationCampaignRestriction_";
	...
	{		
		ServicesUtil.validateParameterNotNullStandardMessage("campaignRestrictionEvaluator", campaignRestriction);
		...
		if (ymktConsentService.getUserConsent(SapymktcommonConstants.PERSONALIZATION_CONSENT_ID)) {
			...
			campaigns = optionalSessionCampaigns.isPresent() ? optionalSessionCampaigns.get() : this.getCampaignsFromBackend();
		...
		LOG.debug("Evaluate with userCampaigns={}, userInCampaign={}, isMemberOfCampaign={}, evaluatorResult={}", campaigns, userBelongsToCampaign, isMemberOfCampaign, evaluatorResult);
