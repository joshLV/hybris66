...
public class DefaultRecommendationBufferServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void setUp()
	{
		...
		restrictedRecoTypeMapping.setRecoType(SapprodrecobufferConstants.RESTRICTED_RECO_TYPE);
		...
		genericRecoTypeMapping.setRecoType(SapprodrecobufferConstants.GENERIC_RECO_TYPE);
	...
	public void testSaveRecommendation()
	{
		...
		recommendationBufferService.saveRecommendation("", SCENARIO_ID_SAVE, HASH_ID_SAVE, "", "",
				SapprodrecobufferConstants.GENERIC_RECO_TYPE, new Date());
		final List<SAPRecoTypeMappingModel> recoTypeMappingResult = //
				recommendationBufferDao.findRecoTypeMapping(SapprodrecobufferConstants.GENERIC_RECO_TYPE, SCENARIO_ID_SAVE);
