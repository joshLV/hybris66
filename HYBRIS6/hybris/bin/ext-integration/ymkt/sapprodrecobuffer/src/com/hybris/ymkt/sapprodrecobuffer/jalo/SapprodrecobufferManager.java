 ...
 */
package com.hybris.ymkt.sapprodrecobuffer.jalo;

import de.hybris.platform.core.Registry;
import com.hybris.ymkt.sapprodrecobuffer.jalo.GeneratedSapprodrecobufferManager;
...
/**
 * This is the extension manager of the Sapprodrecobuffer extension.
 */
public class SapprodrecobufferManager extends GeneratedSapprodrecobufferManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapprodrecobufferManager.class);
	 ...
	 */
	public SapprodrecobufferManager() // NOPMD 
	{
		LOG.debug("constructor of SapprodrecobufferManager called.");
	}
	 ...
	 */
	public static SapprodrecobufferManager getInstance()
	{
		return (SapprodrecobufferManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapprodrecobufferConstants.EXTENSIONNAME);
	}
