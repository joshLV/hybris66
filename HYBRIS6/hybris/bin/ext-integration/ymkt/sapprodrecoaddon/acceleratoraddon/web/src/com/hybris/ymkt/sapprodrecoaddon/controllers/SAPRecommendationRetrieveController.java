...
import com.hybris.ymkt.sapprodreco.dao.InteractionContext;
import com.hybris.ymkt.sapprodreco.dao.RecommendationContext;
import com.hybris.ymkt.sapprodreco.model.CMSSAPRecommendationComponentModel;
import com.hybris.ymkt.sapprodreco.services.InteractionService;
import com.hybris.ymkt.sapprodrecoaddon.facades.ProductRecommendationManagerFacade;
...
public class SAPRecommendationRetrieveController
{
	...
	protected static final String VIEWNAME = "addon:/sapprodrecoaddon/cms/productrecommendationlist";
	...
	public void registerClickthrough(@RequestParam("id") final String id, @RequestParam("componentId") final String componentId)
	{
		if (!getUserConsent())
		{
			LOG.info("User consent to register product clickthrough not given");
			return;
		}

		Optional<CMSSAPRecommendationComponentModel> component = this.getComponent(componentId);
		if (!component.isPresent())
		{
			return;
		}

		Optional<ProductModel> optProduct = this.productRecommendationManagerFacade.findProduct(id);
			...
			final Model model)
	{
		if (!getUserConsent())
		{
			LOG.info("User consent to retrieve product recommendations not given");
			return VIEWNAME;
		}
