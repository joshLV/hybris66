...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PaginationAndSortService_50", {
        get: function () {
            if ((this.__PaginationAndSortService_50 == null)) {
                (this.__PaginationAndSortService_50 = new import8.PaginationAndSortService());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_HttpService_51", {
        get: function () {
            if ((this.__HttpService_51 == null)) {
                (this.__HttpService_51 = new import9.HttpService(this._Http_49));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TicketUtils_52", {
        get: function () {
            if ((this.__TicketUtils_52 == null)) {
                (this.__TicketUtils_52 = new import10.TicketUtils());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_SupportTicketsService_53", {
        get: function () {
            if ((this.__SupportTicketsService_53 == null)) {
                (this.__SupportTicketsService_53 = new import11.SupportTicketsService(this._HttpService_51, this._TicketUtils_52));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ActivatedRoute_54", {
        get: function () {
            if ((this.__ActivatedRoute_54 == null)) {
                (this.__ActivatedRoute_54 = import3.ɵf(this._Router_23));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NoPreloading_55", {
        get: function () {
            if ((this.__NoPreloading_55 == null)) {
                (this.__NoPreloading_55 = new import3.NoPreloading());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RouterPreloader_57", {
        get: function () {
            if ((this.__RouterPreloader_57 == null)) {
                (this.__RouterPreloader_57 = new import3.RouterPreloader(this._Router_23, this._NgModuleFactoryLoader_21, this._Compiler_20, this, this._PreloadingStrategy_56));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PreloadAllModules_58", {
        get: function () {
            if ((this.__PreloadAllModules_58 == null)) {
                (this.__PreloadAllModules_58 = new import3.PreloadAllModules());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ROUTER_INITIALIZER_59", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_59 == null)) {
                (this.__ROUTER_INITIALIZER_59 = import3.ɵi(this._ɵg_3));
            }
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import7.MyAccountModule)) {
            return this._MyAccountModule_13;
        }
        if ((token === import3.ɵa)) {
            return this._ɵa_14;
        }
        ...
        if ((token === import8.PaginationAndSortService)) {
            return this._PaginationAndSortService_50;
        }
        if ((token === import9.HttpService)) {
            return this._HttpService_51;
        }
        if ((token === import10.TicketUtils)) {
            return this._TicketUtils_52;
        }
        if ((token === import11.SupportTicketsService)) {
            return this._SupportTicketsService_53;
        }
