 ...
 */
package de.hybris.platform.customercouponaddon.setup;
...
*
*/
@SystemSetup(extension = CustomercouponaddonConstants.EXTENSIONNAME)
public class CustomerCouponAddonInitialDataSetup extends AbstractSystemSetup
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CustomerCouponAddonInitialDataSetup.class);
