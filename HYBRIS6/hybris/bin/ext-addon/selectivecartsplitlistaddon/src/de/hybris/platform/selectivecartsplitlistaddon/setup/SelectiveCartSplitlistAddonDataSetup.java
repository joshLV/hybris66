...
package de.hybris.platform.selectivecartsplitlistaddon.setup;
 ...
 */
@SystemSetup(extension = SelectivecartsplitlistaddonConstants.EXTENSIONNAME)
public class SelectiveCartSplitlistAddonDataSetup extends AbstractSystemSetup
{
