...
public class ChineseAddressAddonInitialDataSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		getSetupImpexService().importImpexFile(String.format("/%s/import/common/cities.impex", extensionName), false);
		getSetupImpexService().importImpexFile(String.format("/%s/import/common/districts.impex", extensionName), false);
