...
package de.hybris.platform.selectivecartaddon.setup;
 ...
 *
 */
@SystemSetup(extension = SelectivecartaddonConstants.EXTENSIONNAME)
public class SelectiveCartAddonDataSetup extends AbstractSystemSetup
{
