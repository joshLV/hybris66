...
describe('pageService', function() {
    ...
    beforeEach(function() {
        ...
        mocks.cmsitemsRestService.getById.and.returnValue($q.when(true));
        mocks.componentHandlerService.getPageUUID.and.returnValue($q.when(true));
    });
    ...
    it('getCurrentPageInfo will return the page information of current page loaded in the storefront', function() {
        ...
        mocks.componentHandlerService.getPageUUID.and.returnValue('somePageUuid');
