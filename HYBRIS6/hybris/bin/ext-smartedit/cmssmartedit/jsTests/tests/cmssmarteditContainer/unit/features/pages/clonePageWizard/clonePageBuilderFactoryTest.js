...
describe('clonePageBuilderFactory', function() {
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('clonePageWizardServiceModule')
            ...
            .mock('componentHandlerService', 'getPageUUID').and.returnValue('somePageUUID')
        ...
        mockComponentHandlerService = mocks.componentHandlerService;
    ...
    it('WHEN basePageUid is not passed THEN clonePageBuilder will call componentHandlerService to fetch pageUid and then fetch page details', function() {
