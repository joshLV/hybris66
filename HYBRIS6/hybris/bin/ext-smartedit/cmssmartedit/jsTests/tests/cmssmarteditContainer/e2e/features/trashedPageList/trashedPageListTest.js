...
describe('Trashed Page List', function() {
    ...
    it('GIVEN I am on the trashed page list of the first catalog WHEN I click on the removed time column header THEN I expect the list to be re-sorted by this key in the descending order', function() {
        ...
        expect(pageList.elements.getFirstRowForKey('modifiedtime').getText()).toContain('6/28/2016');
        expect(pageList.elements.getLastRowForKey('modifiedtime').getText()).toContain('9/26/2017');

        pageList.actions.clickOnColumnHeader('modifiedtime');
        expect(pageList.elements.getFirstRowForKey('modifiedtime').getText()).toContain('9/26/2017');
        expect(pageList.elements.getLastRowForKey('modifiedtime').getText()).toContain('6/28/2016');
