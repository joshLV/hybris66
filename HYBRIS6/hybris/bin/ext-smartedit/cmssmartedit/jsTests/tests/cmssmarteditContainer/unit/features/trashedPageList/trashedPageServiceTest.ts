...
import {TrashedPageService} from '../../../../../../web/features/cmssmarteditContainer/services/pages/trashedPageService';
...
describe('TrashedPageService - ', () => {
	...
	beforeEach(() => {
		...
		const fixture = AngularUnitTestHelper.prepareModule('trashedPageModule')
