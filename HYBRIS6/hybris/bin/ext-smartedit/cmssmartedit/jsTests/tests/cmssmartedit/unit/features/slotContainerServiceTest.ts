...
import {ContainerInfo, SlotContainerService} from '../../../../../web/features/cmssmartedit/services/slotContainerService';
...
describe('slotContainerService', () => {
	...
	// Tests
	// --------------------------------------------------------------------------------------
	beforeEach(angular.mock.module('restServiceFactoryModule', ($provide: any) => {
		sampleContainerInfo = {
