...
module.exports = (function() {
    ...
    restrictionsEditor.assertions = {
        ...
        restrictionIsNotInList: function(restrictionName) {
            expect(restrictionsEditor.elements.getRestrictionInListByName(restrictionName).isPresent()).toBe(false,
                'Expected restriction ' + restrictionName + ' not to be in the list of selected restrictions');
        },
        ...
        timeRestrictionIsInEditMode: function() {
            expect(restrictionsEditor.elements.getRestrictionTypeDropdown().isPresent()).toBe(false, 'Expected type dropdown not to be present in edit mode');
            expect(restrictionsEditor.elements.getRestrictionsSearchBox().isPresent()).toBe(false, 'Expected restriction search box not to be present in edit mode');
        ...
        restrictionPanelIsEmptyAndNotEditable: function() {
            expect(restrictionsEditor.elements.getRestrictionNameField().isPresent()).toBe(false, 'Expected nameField not to be present');
        },
        ...
        assertRestrictionsYMessageIsNotDisplayed: function() {
            expect(restrictionsEditor.elements.getRestrictionsYMessage().isPresent()).toBe(false);
