...
import {trashedPageModule} from 'cmssmarteditcontainer/modules/trashedPageModule';
...
class NavigationController {
	...
	constructor($routeParams: any, urlService: any, permissionService: any, CONTEXT_CATALOG_VERSION: string, CONTEXT_SITE_ID: string, catalogService: any) {
...
angular.module('cmssmarteditContainer', [
	...
	($log: angular.ILogService, $rootScope: angular.IRootScopeService, $routeParams: any, NAVIGATION_MANAGEMENT_PAGE_PATH: string, ComponentService: any, systemEventService: any, catalogDetailsService: any, featureService: IFeatureService, perspectiveService: any, assetsService: AssetsService, editorFieldMappingService: any, genericEditorTabService: any, cmsDragAndDropService: any, editorModalService: any, clonePageWizardService: any, CATALOG_DETAILS_COLUMNS: any, componentVisibilityAlertService: any, cmsGenericEditorConfigurationService: any) => {
		'ngInject';
