...
angular.module('pageSyncMenuToolbarItemModule', ['crossFrameEventServiceModule', 'catalogServiceModule', 'pageSynchronizationPanelModule'])
    .controller('PageSyncMenuToolbarItemController', function(crossFrameEventService, catalogService, assetsService, systemEventService, iframeClickDetectionService, componentHandlerService, pageSynchronizationService, SYNCHRONIZATION_STATUSES, SYNCHRONIZATION_POLLING, $scope) {
