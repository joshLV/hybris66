...
angular.module('deletePageServiceModule', [
    ...
    .service('deletePageService', function(
        ...
        this.deletePage = function(pageInfo, _uriContext) {
            ...
            var confirmationModalDescription;

            try {
                if (componentHandlerService.getPageUUID()) {
                    confirmationModalDescription = "se.cms.actionitem.page.trash.confirmation.description.storefront";
                }
            } catch (e) {
                if (e.name === "InvalidStorefrontPageError") {
                    confirmationModalDescription = "se.cms.actionitem.page.trash.confirmation.description.pagelist";
                } else {
                    throw e;
                }
            }
