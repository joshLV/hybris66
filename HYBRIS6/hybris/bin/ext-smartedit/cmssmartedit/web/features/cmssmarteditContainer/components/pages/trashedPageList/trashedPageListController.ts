...
export class TrashedPageListController {
	...
	private initialize() {
		...
		this.trashedPageListConfig.renderers = {
			...
			modifiedtime() {
				return '<trashed-page-list-date-printer data-trashed-date="item.modifiedtime"></trashed-page-list-date-printer>';
			},
			syncStatus() {
...
export const trashedPageListControllerModule = angular
	.module('trashedPageListControllerModule', ['urlServiceModule', 'catalogServiceModule', 'pageListTemplatePrinterModule', 'trashedPageListDatePrinterModule', 'resourceLocationsModule'])
