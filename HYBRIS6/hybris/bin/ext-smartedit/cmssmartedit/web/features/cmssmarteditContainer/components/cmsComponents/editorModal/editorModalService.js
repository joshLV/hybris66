 ...
 */
angular.module('editorModalServiceModule', ['genericEditorModalServiceModule', 'gatewayProxyModule', 'typeStructureRestServiceModule', 'renderServiceModule', 'cmsitemsRestServiceModule', 'slotVisibilityServiceModule', 'yLoDashModule'])
    .factory('editorModalService', function($q, isBlank, genericEditorModalService, gatewayProxy, renderService, cmsitemsRestService, slotVisibilityService) {
