...
/**
 * EnumDataConverterTest is a suite of test cases for testing the mapping of a <code>HybrisEnumValue</code> type to a
...
public class EnumDataConverterTest
{
	...
	{
		final TestEnumModel enum1 = TestEnumModel.TEST_ENUM1;
		final EnumData ed = converter.convert(enum1);
