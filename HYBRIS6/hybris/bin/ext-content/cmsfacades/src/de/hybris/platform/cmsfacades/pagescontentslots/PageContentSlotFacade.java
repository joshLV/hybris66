...
public interface PageContentSlotFacade
{
	 ...
	 * @deprecated since version 6.3; Please use {@link PageContentSlotFacade#getContentSlotsByPage(String)} to retrieve shared
	 *             content slot information
	 *             instead.
	 */
	@Deprecated
	@HybrisDeprecation(sinceVersion = "6.3")
	List<PageContentSlotData> getPagesBySlotId(String slotId) throws CMSItemNotFoundException, ConversionException;
