...
public class DefaultMediaFacade implements MediaFacade
{
	...
	@Override
	public MediaData getMediaByUUID(final String uuid) throws MediaNotFoundException
	{
		final MediaModel mediaModel = getUniqueItemIdentifierService().getItemModel(uuid, MediaModel.class).orElseThrow(() -> new MediaNotFoundException("Media with uuid \"" + uuid + "\" not found."));
		return getMediaModelConverter().convert(mediaModel);
	}

	@Override
	public MediaData getMediaByCode(final String code) throws MediaNotFoundException
	{
	...
	@Override
	public List<MediaData> getMediaByNamedQuery(final NamedQueryData namedQueryData) throws ValidationException
	{
	...
	@Override
	public MediaData addMedia(final MediaData media, final MediaFileDto mediaFile) throws ValidationException, ConversionException
	{
