...
angular.module('genericEditorModule', ['yjqueryModule', 'genericEditorTabModule', 'restServiceFactoryModule', 'functionsModule', 'eventServiceModule', 'coretemplates', 'translationServiceModule', 'languageServiceModule', 'experienceInterceptorModule', 'dateTimePickerModule', 'seBooleanModule', 'fetchEnumDataHandlerModule', 'seRichTextFieldModule', 'seValidationMessageParserModule', 'seDropdownModule', 'editorFieldMappingServiceModule', 'genericEditorTabServiceModule', 'genericEditorStackServiceModule', 'genericEditorBreadcrumbModule', 'yLoDashModule', 'seConstantsModule'])
        ...
        GenericEditor.prototype._displayValidationMessages = function(validationMessages) {
            validationMessages.filter(function(message) {
                ...
                if (field) {
                    ...
                    message.uniqId = btoa(JSON.stringify(message));
    ...
    .controller('GenericEditorController', function(GenericEditor, isBlank, generateIdentifier, yjQuery, $element, $attrs, $scope) {
