...
(function() {
     ...
     *
     */
    angular.module('dragAndDropServiceModule', ['yjqueryModule', 'yLoDashModule', '_dragAndDropScrollingModule', 'eventServiceModule', 'seConstantsModule'])
         ...
         * experience.
         */
        .service('dragAndDropService', function($timeout, yjQuery, lodash, _dragAndDropScrollingService, systemEventService, ENABLE_COMPONENT_DECORATOR, DISABLE_COMPONENT_DECORATOR) {
            // Constants
            ...
            this._setDragAndDropExecutionStatus = function(isExecuting) {
                ...
                systemEventService.sendSynchEvent(isExecuting ? DISABLE_COMPONENT_DECORATOR : ENABLE_COMPONENT_DECORATOR);
            };
