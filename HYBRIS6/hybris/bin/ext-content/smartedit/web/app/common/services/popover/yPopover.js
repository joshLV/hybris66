...
angular.module('yPopoverModule', [
    ...
    .controller('yPopoverController', function($scope, $element, $sce, isBlank, $templateCache, yPopupEngineService, componentHandlerService) {
        this.engine = null;
        this.config = null;
        ...
        this.$onInit = function() {
            ...
            this.config = {
                ...
                container: (overlay.length) ? overlay[0] : 'body',
                onShow: function() {
                    this.isOpen = true;
                }.bind(this),
                onHide: function() {
