...
(function() {
     ...
     *
     */
    angular.module('renderServiceInterfaceModule', ['eventServiceModule', 'componentHandlerServiceModule', 'notificationServiceModule', 'seConstantsModule', 'componentHandlerServiceModule', 'perspectiveServiceModule', 'crossFrameEventServiceModule'])
        .constant("KEY_CODES", {
            ESC: 27
        })
    ...
    function createRenderServiceInterface($document, $window, $q, KEY_CODES, MOUSE_AND_KEYBOARD_EVENTS, OVERLAY_DISABLED, MODAL_DIALOG_ID, NONE_PERSPECTIVE, EVENT_OUTER_FRAME_CLICKED, systemEventService, notificationService, componentHandlerService, perspectiveService, crossFrameEventService) {
