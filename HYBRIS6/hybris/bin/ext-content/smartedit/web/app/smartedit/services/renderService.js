...
angular.module('renderServiceModule', [
    ...
    .service('renderService', function(
        $q, $timeout, $compile, $rootScope, $http, $location, $window, $log, alertService,
        componentHandlerService, extractFromElement, gatewayFactory, gatewayProxy, isBlank, sakExecutor,
        perspectiveService, RenderServiceInterface, unsafeParseHTML, crossFrameEventService, systemEventService, COMPONENT_CLASS,
        UUID_ATTRIBUTE, CATALOG_VERSION_UUID_ATTRIBUTE, ID_ATTRIBUTE, OVERLAY_COMPONENT_CLASS, OVERLAY_ID,
        SMARTEDIT_ATTRIBUTE_PREFIX, TYPE_ATTRIBUTE, ELEMENT_UUID_ATTRIBUTE, CONTAINER_ID_ATTRIBUTE, lodash, OVERLAY_RERENDERED_EVENT, EVENT_PERSPECTIVE_CHANGED,
        CONTRACT_CHANGE_LISTENER_PROCESS_EVENTS, CONTRACT_CHANGE_LISTENER_COMPONENT_PROCESS_STATUS, SMARTEDIT_COMPONENT_PROCESS_STATUS,
        seNamespace, generateIdentifier) {
        ...
        this._updateComponentSizeAndPosition = function(componentElem, componentOverlayElem) {
            ...
            componentOverlayElem = componentOverlayElem ||
                componentHandlerService._getComponentCloneInOverlay(componentElem).get(0);
