 ...
 */
angular.module('experienceSelectorButtonModule', ['eventServiceModule', 'crossFrameEventServiceModule', 'sharedDataServiceModule', 'l10nModule', 'seConstantsModule', 'componentHandlerServiceModule', 'seConstantsModule'])
    .controller('experienceSelectorButtonController', function(EVENTS, DATE_CONSTANTS, systemEventService, crossFrameEventService, sharedDataService, l10nFilter, dateFilter, componentHandlerService) {
        ...
        this.setPageFromParent = function(eventId, data) {
            var currentPageCatalogVersionUuid = componentHandlerService.getCatalogVersionUUIDFromPage();
