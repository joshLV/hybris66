 ...
 */
angular.module('experienceServiceModule', ['crossFrameEventServiceModule', 'siteServiceModule', 'catalogServiceModule', 'languageServiceModule', 'sharedDataServiceModule', 'yLoDashModule', 'componentHandlerServiceModule', 'gatewayProxyModule'])
     ...
     */
    .service('experienceService', function($q, $location, crossFrameEventService, EVENTS, siteService, catalogService, languageService, sharedDataService, lodash, componentHandlerService, gatewayProxy, STOREFRONT_PATH_WITH_PAGE_ID) {
        ...
        ExperienceService.prototype.updateExperiencePageContext = function() {
            ...
            var pageCatalogVersionUuid = componentHandlerService.getCatalogVersionUUIDFromPage();
