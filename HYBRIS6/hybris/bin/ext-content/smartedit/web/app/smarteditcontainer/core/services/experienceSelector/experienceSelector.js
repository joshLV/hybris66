 ...
 */
angular.module('experienceSelectorModule', ['eventServiceModule', 'recompileDomModule', 'genericEditorModule', 'sharedDataServiceModule', 'iframeClickDetectionServiceModule', 'iFrameManagerModule', 'siteServiceModule', 'genericEditorModule', 'resourceLocationsModule', 'previewDataDropdownPopulatorModule', 'experienceServiceModule', 'yLoDashModule', 'functionsModule', 'catalogServiceModule'])
    ...
    .controller('ExperienceSelectorController', function($q, $scope, $filter, $timeout, $document, systemEventService, siteService, sharedDataService, iframeClickDetectionService, iFrameManager, GenericEditor, experienceService, EVENTS, TYPES_RESOURCE_URI, PREVIEW_RESOURCE_URI, lodash, formatDateAsUtc, catalogService) {
        var siteCatalogs = {};
