...
angular.module('bootstrapServiceModule', ['functionsModule', 'configurationExtractorServiceModule', 'sharedDataServiceModule', 'gatewayFactoryModule'])
    .factory('bootstrapService', function(configurationExtractorService, sharedDataService, injectJS, $log, $http, $q, customTimeout, WHITE_LISTED_STOREFRONTS_CONFIGURATION_KEY) {
        ...
        return {
            ...
            bootstrapContainerModules: function(configurations) {
                ...
                injectJS.execute({
                    ...
                    callback: function() {
                        seContainerModules.applications.forEach(function(app) {
