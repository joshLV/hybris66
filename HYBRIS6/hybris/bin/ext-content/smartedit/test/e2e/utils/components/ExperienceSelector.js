    ...
    var ExperienceSelectorObject = {
        ...
        actions: {
            ...
            widget: {
                ...
                submit: function() {
                    return browser.click(element(by.id('submit', 'Experience Selector Apply Button not found')));
                },
                cancel: function() {
                    return browser.click(element(by.id('cancel', 'Experience Selector Apply Button not found')));
                }
            },
