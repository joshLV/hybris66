...
(function() {
    angular
        ...
        .run(function($httpBackend, languageService, $location, I18N_RESOURCE_URI, STOREFRONT_PATH, parseQuery) {
            var map = [{
            ...
            $httpBackend.whenPOST(/thepreviewTicketURI/)
                .respond({
                    ...
                    resourcePath: document.location.origin + '/test/e2e/routing/smarteditiframe.html'
                });
