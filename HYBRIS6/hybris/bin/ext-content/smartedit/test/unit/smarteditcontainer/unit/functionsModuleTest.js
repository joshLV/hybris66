...
describe('functionsModule', function() {
    ...
    var escapeHtml, getDataFromResponse, getKeyHoldingDataFromResponse, isBlank, hitch, copy, customTimeout, merge, getQueryString, parseQuery, trim, convertToArray, uniqueArray, regExpFactory, generateIdentifier, closeOpenModalsOnBrowserBack, $uibModalStack, isAllTruthy, isAnyTruthy, compareHTMLElementsPosition;
