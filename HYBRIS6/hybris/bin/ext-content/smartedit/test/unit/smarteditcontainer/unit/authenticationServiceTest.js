...
describe('outer AuthenticationService', function() {
    ...
    beforeEach(module("authenticationModule", function($provide) {
        ...
        sessionService = jasmine.createSpyObj('sessionService', ['hasUserChanged', 'setCurrentUsername']);
    ...
    it('authenticate will launch modalService and remove authInprogress flag', function() {
        ...
        expect(modalService.open).toHaveBeenCalledWith({
            cssClasses: "se-login-modal--init",
    ...
    describe('controller of authenticationService with non default endpoint', function() {
        ...
        beforeEach(function() {
            ...
            systemEventService.sendAsynchEvent.and.callFake(function() {
                return $q.when();
            });
        });
