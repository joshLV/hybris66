...
describe('renderService', function() {
    ...
    var crossFrameEventService, systemEventService, alertService, componentHandlerService, extractFromElement, gatewayFactory, gatewayProxy, unsafeParseHTML,
        renderService, RenderServiceInterface, sakExecutor, smartEditBootstrapGateway, perspectiveService, resizeCallback, CONTRACT_CHANGE_LISTENER_PROCESS_EVENTS;
    ...
    beforeEach(module('componentHandlerServiceModule', function($provide) {
        componentHandlerService = jasmine.createSpyObj('componentHandlerService', ['getFromSelector', 'getOverlay', 'isOverlayOn', 'getParent', 'getComponentUnderSlot', 'getComponent', 'getOriginalComponent', 'getComponentInOverlay', 'getParentSlotForComponent', 'getOverlayComponentWithinSlot', 'getOverlayComponent', 'isSmartEditComponent', 'getFirstSmartEditComponentChildren', '_getComponentCloneInOverlay']);
    ...
    describe('_updateComponentSizeAndPosition', function() {
        ...
        beforeEach(function() {
            ...
            componentHandlerService._getComponentCloneInOverlay.and.returnValue(componentInOverlayList);
        ...
        it('_updateComponentSizeAndPosition should fetch the component in overlay', function() {
            ...
            expect(componentHandlerService._getComponentCloneInOverlay).toHaveBeenCalledWith(originalElement);
        ...
        it('should not fetch the component in overlay if it is provided', function() {
            ...
            expect(componentHandlerService._getComponentCloneInOverlay).not.toHaveBeenCalled();
