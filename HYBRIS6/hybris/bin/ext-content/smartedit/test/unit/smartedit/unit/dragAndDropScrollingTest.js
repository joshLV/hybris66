...
describe('dragAndDropScrollingService', function() {
    ...
    beforeEach(function() {
        ...
        scrollAreas = jasmine.createSpyObj('scrollAreas', ['on', 'off', 'appendTo', 'height', 'text', 'hide', 'show', 'remove']);
    ...
    it('WHEN disable is called THEN the scroll areas are shown', function() {
        // Arrange
        dragAndDropScrollingService._initialized = true;
