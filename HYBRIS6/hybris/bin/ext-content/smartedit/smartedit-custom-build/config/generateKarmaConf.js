        ...
        config: function(data, conf) {
            ...
            const unitSmarteditConf = {
                ...
                files: lodash.concat(
                    ...
                    'web/app/common/**/*.+(js|ts)',
                    'web/app/smartedit/core/**/*.+(js|ts)',
                    'web/app/smartedit/services/**/*.+(js|ts)',
                    'web/app/smartedit/modules/systemModule/features/**/*.+(js|ts)',
                    'web/app/smartedit/modules/systemModule/services/toolbar/toolbar.js',
                ...
                exclude: [
                    'web/app/smartedit/core/smartedit.ts',
                    'web/app/smartedit/partialBackendMocks.js',
                    'web/app/smartedit/core/smarteditbootstrap.ts',
                    '**/index.ts',
                    '**/*.d.ts'
                ],
            ...
            const unitSmarteditContainer = {
                ...
                files: lodash.concat(
                    ...
                    'jsTarget/templates.js',
                    'web/app/common/**/*.+(js|ts)',
                    'web/app/smarteditcontainer/**/*.+(js|ts)',
