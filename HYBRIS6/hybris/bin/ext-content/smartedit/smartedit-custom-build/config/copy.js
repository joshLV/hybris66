            ...
            return {
                ...
                toDummystorefront: {
                    files: [{
                        ...
                        flatten: true,
                        src: [
                            paths.thirdparties.dir + '/angular/angular.min.js',
                            ...
                            paths.thirdparties.dir + '/polyfills/startsWithPolyfill.js', // for IE
                            paths.thirdparties.dir + '/polyfills/endsWithPolyfill.js', // for IE
                            'jsTarget/webApplicationInjector.js',
                            'node_modules/techne/node_modules/bootstrap/dist/css/bootstrap.css'
                        ],
                ...
                dev: {
                    files: [
                        // includes files within path
                        {
                            ...
                            expand: true,
                            flatten: true,
                            src: ['jsTarget/presmartedit.js*(.map)'],
                            dest: paths.web.webroot.staticResources.dir + '/dist/smartedit/js'
                        }, {
                            expand: true,
                            flatten: true,
                            src: ['jsTarget/postsmartedit.js*(.map)'],
                            dest: paths.web.webroot.staticResources.dir + '/dist/smartedit/js'
                        }, {
                            expand: true,
                            flatten: true,
                ...
                modules: {
                    files: [{
                        expand: true,
                        flatten: true,
                        src: ['jsTarget/administrationModule.js*(.map)'],
                        dest: paths.web.webroot.staticResources.dir + '/smarteditcontainer/modules'
                    }, {
                        expand: true,
                        flatten: true,
                        src: ['jsTarget/systemModule.js*(.map)'],
                        dest: paths.web.webroot.staticResources.dir + '/smartedit/modules'
                    }]
                }
            };
        }
