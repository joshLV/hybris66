angular.module('personalizationsmarteditContextMenu', [
    ...
    .factory('personalizationsmarteditContextModal', function($controller, modalService, MODAL_BUTTON_ACTIONS, MODAL_BUTTON_STYLES, $filter, personalizationsmarteditMessageHandler, gatewayProxy, personalizationsmarteditContextService, renderService, personalizationsmarteditRestService, editorModalService, personalizationsmarteditUtils, slotVisibilityService) {
        ...
        PersonalizationsmarteditContextModal.prototype.openDeleteAction = function(config) {
            modalService.open({
                ...
                renderService.renderSlots([config.slotId]).then(function() {
