    ...
    grunt.initConfig({
        ...
        ngdocs: {
            ...
            personalizationsmartedit: {
                api: true,
                src: ['web/features/personalizationcommons/**/*.js', 'web/features/personalizationsmartedit/**/*.js'],
                title: 'personalizationsmartedit'
            },
            personalizationsmarteditcontainer: {
                api: true,
                src: ['web/features/personalizationcommons/**/*.js', 'web/features/personalizationsmarteditcontainer/**/*.js'],
        ...
        karma: {
            options: {
                configFile: 'jsTests/unit/personalizationcommons/karma.conf.js',
            },
            unitCommons: {
                configFile: 'jsTests/unit/personalizationcommons/karma.conf.js',
                singleRun: true
        ...
        grunt.file.expand({
            ...
            if (!endsWith(dir, "/commons")) {
                ...
                multiConcatTask[folderName] = {
                    src: ["jsTarget/web/features/personalizationcommons/**/*.js", dir + '/**/*.js'],
