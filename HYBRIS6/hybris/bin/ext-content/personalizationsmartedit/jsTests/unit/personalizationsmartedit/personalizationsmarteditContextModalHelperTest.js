describe('personalizationsmarteditContextModalHelper', function() {
    ...
    beforeEach(module('personalizationsmarteditContextMenu', function($provide) {
        ...
        mockModules.personalizationsmarteditComponentHandlerService = jasmine.createSpyObj('personalizationsmarteditComponentHandlerService', ['getParentSlotForComponent', 'getCatalogVersionUuid']);
