...
module.exports = function(config) {
    config.set({
        ...
        coverageReporter: {
            ...
            dir: 'jsTarget/test/personalizationcommons/coverage/',
            reporters: [{
                type: 'html',
                subdir: 'report-html'
            }, {
        ...
        junitReporter: {
            outputDir: 'jsTarget/test/personalizationcommons/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: [
            ...
            'jsTests/unit/personalizationcommons/*Test.js'
        ],
