window.setupMockModules = function(container) {
    ...
    beforeEach(function() {
        module(['$provide', function($provide) {
            ...
            $provide.constant('CONTAINER_TYPE_ATTRIBUTE', '');
            $provide.constant('COMPONENT_CONTAINER_TYPE', '');
            $provide.constant('CONTAINER_ID_ATTRIBUTE', '');
            $provide.constant('TYPE_ATTRIBUTE', '');
            $provide.constant('CONTENT_SLOT_TYPE', '');
        }]);
    });
    ...
    beforeEach(module('componentHandlerServiceModule', function($provide) {
        container.componentHandlerService = jasmine.createSpyObj('componentHandlerService', ['getParentSlotForComponent', 'isExternalComponent']);
