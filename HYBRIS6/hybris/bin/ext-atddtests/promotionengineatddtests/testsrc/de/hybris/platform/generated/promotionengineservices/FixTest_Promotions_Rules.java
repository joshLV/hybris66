	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20171120122729_promotionengine_artifact_release_6.6.0_cf83299/prepare/build/source/promotionengineatddtests/genresources/robottests/FixTest_Promotions_Rules.txt"));
		}
