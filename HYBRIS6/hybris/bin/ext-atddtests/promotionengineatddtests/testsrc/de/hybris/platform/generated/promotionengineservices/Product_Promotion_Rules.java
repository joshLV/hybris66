...
public class Product_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20171120122729_promotionengine_artifact_release_6.6.0_cf83299/prepare/build/source/promotionengineatddtests/genresources/robottests/Product_Promotion_Rules.txt"));
		}
	...
	@Test
	public void Test_Product_Percentage_And_Order_Fixed_Discount()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Percentage_And_Order_Fixed_Discount";
