	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20171129191802_commerceservices_artifact_support_6.6.0.0/prepare/build/source/commerceservicesatddtests/genresources/robottests/Save_Cart_Unsave_Dao.txt"));
		}
