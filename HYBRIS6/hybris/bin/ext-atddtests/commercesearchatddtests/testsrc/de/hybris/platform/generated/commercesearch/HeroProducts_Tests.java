	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20171106125003_commercesearch_artifact_develop_58f3b40/prepare/build/source/commercesearchatddtests/genresources/robottests/HeroProducts_Tests.txt"));
		}
