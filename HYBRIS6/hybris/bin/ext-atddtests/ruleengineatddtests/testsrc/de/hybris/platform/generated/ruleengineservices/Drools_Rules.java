	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20171120105730_ruleengine_artifact_release_6.6.0_e73a14b/prepare/build/source/ruleengineatddtests/genresources/robottests/Drools_Rules.txt"));
		}
