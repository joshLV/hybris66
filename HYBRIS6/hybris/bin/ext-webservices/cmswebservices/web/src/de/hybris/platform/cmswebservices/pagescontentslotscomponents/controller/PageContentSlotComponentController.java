...
public class PageContentSlotComponentController
{
	...
	@ResponseStatus(value = HttpStatus.OK)
	@ApiOperation(value = "Update page content slot component", notes = "Update a component by changing the content slot where it is placed inside a page. "
			+ "This resource is deprecated since version 6.2, please use PUT /pagescontentslotscomponents/pages/{pageId}/contentslots/{slotId}/components/{componentId} instead.")
	@ApiResponses({
	...
	public @ResponseBody PageContentSlotComponentData updatePageContentSlotComponent(
			@ApiParam(value = "Identifier of the page which contains the component", required = true) @RequestParam("pageId") final String pageId,
			@ApiParam(value = "Identifier of the initial content slot containing the component to be moved", required = true) @RequestParam("slotId") final String slotId,
			@ApiParam(value = "Identifier of the component to be moved", required = true) @RequestParam("componentId") final String componentId,
	...
	@ApiOperation(value = "Remove component from slot", notes = "Remove a component from a slot. This resource is deprecated since version 6.2, please use DELETE /pagescontentslotscomponents/contentslots/{slotId}/components/{componentId} instead.")
	@ApiResponses({
	...
	public void removeComponentFromSlot(
			@ApiParam(value = "Content slot id containing the component to be removed", required = true) @RequestParam("slotId") final String slotId,
			@ApiParam(value = "Identifier of the component to be removed", required = true) @RequestParam("componentId") final String componentId) throws CMSItemNotFoundException, ComponentNotFoundInSlotException
	{
