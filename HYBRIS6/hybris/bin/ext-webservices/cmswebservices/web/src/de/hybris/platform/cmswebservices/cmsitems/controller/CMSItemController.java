...
public class CMSItemController
{
	...
	public void removeCMSItembyUUid(
													 @ApiParam(value = "The universally unique identifier of the item", required = true) @PathVariable final String uuid)
	...
	public Map<String, Object> createCMSItem(
																 @ApiParam(value = "Map representing the CMS item to create", required = true) @RequestBody final Map<String, Object> inputMap,
	...
	public Map<String, Object> validateCMSItemForCreation(
																				  @ApiParam(value = "When set to TRUE, the request is executed in Dry Run mode", required = true) @RequestParam("dryRun") final Boolean dryRun,
																				  @ApiParam(value = "Map representing the CMS item to create in Dry Run mode", required = true) @RequestBody final Map<String, Object> inputMap,
																				  final HttpServletRequest request,
																				  final HttpServletResponse response) throws CMSItemNotFoundException
	{
		try
	...
	public Map<String, Object> updateCMSItem(
																 @ApiParam(value = "Unique Identifier of a CMS Item", required = true) @PathVariable final String uuid,
																 @ApiParam(value = "Map representing the CMS item to update", required = true) @RequestBody final Map<String, Object> inputMap)
	...
	public Map<String, Object> validateCMSItemForUpdate(
																				@ApiParam(value = "When set to TRUE, the request is executed in Dry Run mode", required = true) @RequestParam("dryRun") final Boolean dryRun,
																				@ApiParam(value = "Unique Identifier of a CMS Item", required = true) @PathVariable final String uuid,
																				@ApiParam(value = "Map representing the CMS item to validate", required = true) @RequestBody final Map<String, Object> inputMap)
			throws WebserviceValidationException, CMSItemNotFoundException
	{
		try
		{
	...
	public Map<String, Object> findCmsItems(
																@ApiParam(value = "CMS Item search DTO", required = true) @ModelAttribute final CMSItemSearchWsDTO cmsItemSearchWsDTO,
