...
public class DefaultCxProfileIdentifierStrategyTest
{
	...
	public void setUp()
	{
		...
		profileReference.setProfileId(PROFILE_ID);
	...
	public void testGetProfileIdentifierForAnonymousUser()
	{
		//given
		when(sessionService.getAttribute(sessionAttrKey)).thenReturn(null);
		when(sessionService.getAttribute(DefaultCxProfileIdentifierStrategy.CONSENT_REFERENCE_SESSION_ATTR_KEY))
				.thenReturn(CONSENT_REFERENCE_VALUE);
	...
	@Test
	public void testGetProfileIdentifierForConsentReference()
	{
		//given
		when(sessionService.getAttribute(sessionAttrKey)).thenReturn(null);
		when(sessionService.getAttribute(DefaultCxProfileIdentifierStrategy.CONSENT_REFERENCE_SESSION_ATTR_KEY))
	...
	public void testNoProfileIdentifier()
	{
		...
		when(sessionService.getAttribute(sessionAttrKey)).thenReturn(null);
		when(cxIdentityServiceClient.getProfileReferences(USER_ID, IDENTITY_TYPE_EMAIL, IDENTITY_ORIGIN_USER_ACCOUNT))
				.thenThrow(new HttpException(Integer.valueOf(400), "Bad request"));
		when(sessionService.getAttribute(DefaultCxProfileIdentifierStrategy.CONSENT_REFERENCE_SESSION_ATTR_KEY)).thenReturn(null);
