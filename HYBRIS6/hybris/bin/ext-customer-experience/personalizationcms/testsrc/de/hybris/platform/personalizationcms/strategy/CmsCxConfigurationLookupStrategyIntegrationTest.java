...
@IntegrationTest
public class CmsCxConfigurationLookupStrategyIntegrationTest extends AbstractCxServiceTest
{
	...
	{
		//given
		final CatalogVersionModel catalogVersion = catalogVersionService.getCatalogVersion(CONTENT_CATALOG_WITH_SINGLE_BASE_SITE, CATALOG_VERSION);
