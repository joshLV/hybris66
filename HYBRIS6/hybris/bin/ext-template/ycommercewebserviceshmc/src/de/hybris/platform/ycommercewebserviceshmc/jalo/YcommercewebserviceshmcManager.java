...
public class YcommercewebserviceshmcManager extends GeneratedYcommercewebserviceshmcManager
{
	...
	{
		return (YcommercewebserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YcommercewebserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YcommercewebserviceshmcManager()
	{
