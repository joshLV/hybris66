        ...
        config: function(data, conf) {
            ...
            const ysmarteditmoduleContainer = {
                ...
                files: lodash.concat(
                    ...
                    pathsInBundle.test.unit.commonUtilModules, [
                        'web/features/ysmarteditmodulecommons/**/*.+(js|ts)',
                        'web/features/ysmarteditmoduleContainer/**/*.+(js|ts)',
                        'jsTarget/web/features/ysmarteditmoduleContainer/templates.js',
                        'jsTests/ysmarteditmoduleContainer/unit/features/**/*.+(js|ts)'
                    ]
                ),

                // list of files to exclude
                exclude: [
                    'web/features/ysmarteditmoduleContainer/ysmarteditmodulecontainer.ts',
                    '**/*.d.ts',
                    '*.d.ts'
                ],
            ...
            const ysmarteditmodulecommons = {
                ...
                junitReporter: {
                    outputDir: 'jsTarget/test/ysmarteditmodulecommons/junit/', // results will be saved as $outputDir/$browserName.xml
                    outputFile: 'testReport.xml' // if included, results will be saved as $outputDir/$browserName/$outputFile
                },
                ...
                files: lodash.concat(
                    ...
                    pathsInBundle.test.unit.commonUtilModules, [
                        ...
                        'jsTests/ysmarteditmodulecommons/unit/features/**/*.+(js|ts)'
                    ]
                ),
