...
public class TestSetupUtils
{
	...
	{
		final BaseSiteService baseSiteService = Registry.getApplicationContext().getBean(BaseSiteService.class, "baseSiteService");
	...
	{
		final UserService userService = Registry.getApplicationContext().getBean(UserService.class, "userService");
	...
	private static void setupCore() throws Exception
	{
		...
		Registry.getApplicationContext().getBean(ServiceLayerDataSetup.class, "serviceLayerDataSetup").setup();
	...
	{
		final DefaultCommandFactoryRegistryImpl commandFactoryReg = Registry.getApplicationContext().getBean(
		...
		final DefaultCardPaymentServiceImpl cartPaymentService = Registry.getApplicationContext().getBean(
	...
	{
		return Registry.getApplicationContext().getBean(YCommerceWebServicesTestSetup.class,
	...
	{
		final EmbeddedServerController controller = Registry.getApplicationContext().getBean(EmbeddedServerController.class,
