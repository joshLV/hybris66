...
public class OmsReturnsController extends OmsBaseController
{
	...
	public ReturnRequestWsDTO updateReturnByReturnCode(
			...
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		final ReturnRequestModificationData returnRequestModificationData =  dataMapper.map(returnRequestModificationWsDTO, ReturnRequestModificationData.class, fields);
