...
public class OmsOrdersController extends OmsBaseController
{
	...
	public OrderWsDTO getOrderForCode(
			@ApiParam(value = "The order code") @PathVariable final String code,
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
	...
	public OrderEntrySearchPageWsDTO getOrderEntriesForOrderCode(
			@ApiParam(value = "Order code") @PathVariable final String code,
			@ApiParam(value = "Fields mapping level", required = false)@RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields,
			@ApiParam(value = "Current page number", required = false) @RequestParam(required = false, defaultValue = DEFAULT_CURRENT_PAGE) final int currentPage,
	...
	{
		final PageableData pageableData = createPageable(currentPage, pageSize, sort);
		final SearchPageData<OrderEntryData> orderEntrySearchPageData = omsOrderFacade
	...
	public OrderEntryWsDTO getOrderEntryForOrderCodeAndEntryNumber(
			...
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		final OrderEntryData orderEntryData = omsOrderFacade
			...
			@ApiParam(value = "Fields mapping level", required = false) @RequestParam(required = false, defaultValue = DEFAULT_FIELD_SET) final String fields)
	{
		...
		final OrderData submittedOrderData = omsOrderFacade.submitOrder(orderRequestData);
