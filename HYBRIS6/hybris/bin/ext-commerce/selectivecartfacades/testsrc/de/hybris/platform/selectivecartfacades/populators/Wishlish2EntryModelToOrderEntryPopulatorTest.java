...
public class Wishlish2EntryModelToOrderEntryPopulatorTest
{
	...
	public void testPopulateWithSuccessfulResult()
	{
		...
		wishlish2EntryModelToOrderEntryPopulator.setProductPricePopulator(productPricePopulator);
		wishlish2EntryModelToOrderEntryPopulator.setProductStockPopulator(productStockPopulator);
