...
/**
 * @deprecated Since 5.0. Please use {@link de.hybris.platform.converters.impl.AbstractPopulatingConverter}
 * 
		...
		de.hybris.platform.converters.impl.AbstractPopulatingConverter<SOURCE, TARGET>
{
	...
	/**
	 * @deprecated Since 5.2. Please inject the target class directly, since it's way faster than the Spring <lookup-method>
	 *             approach!
	 */
	@Override
	@Deprecated
