...
public class DefaultRecentlyStartedSessionCustomerListSearchStrategyTest extends ServicelayerTest
{
	...
	{
		final EmployeeModel asagent = userService.getUserForUID("asagent", EmployeeModel.class);
		final CustomerModel user2 = userService.getUserForUID("user2", CustomerModel.class);
		final CustomerModel user1 = userService.getUserForUID("user1", CustomerModel.class);
	...
	{
		final SearchPageData<CustomerModel> customers = defaultRecentlyStartedSessionCustomerListSearchStrategy
				.getPagedCustomers("bopis",
				"asagent", pageableData, null);
