...
public class DefaultCustomerGroupDao extends DefaultPagedGenericDao<CustomerModel> implements CustomerGroupDao
{
			...
			final PageableData pageableData)
	{
		...
		return getPagedFlexibleSearchService().search(sortQueries, SORT_BY_NAME_ASC, Collections.singletonMap(GROUPS_UID, groups),
				pageableData);
	}
			...
			final List<PointOfServiceModel> poses, final PageableData pageableData)
	{
		...
		return getPagedFlexibleSearchService().search(sortQueries, SORT_BY_ORDER_DATE_DESC,
