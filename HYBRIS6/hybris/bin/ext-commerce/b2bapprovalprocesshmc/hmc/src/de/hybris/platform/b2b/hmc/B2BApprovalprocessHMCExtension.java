...
/**
 * Provides necessary meta information about the b2approvalprocess hmc extension.
 */
public class B2BApprovalprocessHMCExtension extends HMCExtension
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2BApprovalprocessHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.b2b.hmc.b2bapprovalprocess_locales";
