...
import de.hybris.platform.b2b.constants.B2bapprovalprocesshmcConstants;
...
/**
 * This is the extension manager of the B2bapprovalprocesshmc extension.
 */
public class B2bapprovalprocesshmcManager extends GeneratedB2bapprovalprocesshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2bapprovalprocesshmcManager.class.getName());
	 ...
	 */
	public static B2bapprovalprocesshmcManager getInstance()
	{
		return (B2bapprovalprocesshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bapprovalprocesshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bapprovalprocesshmcManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bapprovalprocesshmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bapprovalprocesshmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bapprovalprocesshmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
