...
public class DefaultChineseCheckoutFacade extends DefaultAcceleratorCheckoutFacade implements ChineseCheckoutFacade
{
	 ...
	 */
	private OrderData reserveStockAfterPlaceOrder(OrderModel orderModel) throws BusinessException{
	 ...
	 * @throws BusinessException
	 */
	private void processPickupReserveStock(OrderData orderData) throws BusinessException{
	 ...
	 * @throws BusinessException
	 */
	private void processDeliveryReserveStock(OrderData orderData) throws BusinessException{
