...
public class CommerceserviceshmcManager extends GeneratedCommerceserviceshmcManager
{
	...
	{
		return (CommerceserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CommerceserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CommerceserviceshmcManager()
	{
