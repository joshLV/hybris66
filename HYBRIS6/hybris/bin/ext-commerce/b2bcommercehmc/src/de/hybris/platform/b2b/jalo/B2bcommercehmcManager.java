...
import de.hybris.platform.b2b.constants.B2bcommercehmcConstants;
...
/**
 * This is the extension manager of the B2bcommercehmc extension.
 */
public class B2bcommercehmcManager extends GeneratedB2bcommercehmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2bcommercehmcManager.class.getName());
	 ...
	 */
	public static B2bcommercehmcManager getInstance()
	{
		return (B2bcommercehmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(B2bcommercehmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2bcommercehmcManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2bcommercehmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2bcommercehmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2bcommercehmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
