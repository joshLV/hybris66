...
public class MockService
{
	...
	/**
	 * Create the valid Link String of this parameter.
	 *
	 * @param params
	 *           the parameters provided by user for creation of Link
	...
	/**
	 * Get the notify of the params and the trade status.
	 *
	 * @param params
	 *           the parameters provided by user to get the notify
	 * @param tradeStatus
	 *           the parameters provided by user to set notify trade_status
	 * @return a HashMap of the notify
	 */
	...
	/**
	 * Get the notify errors of the params and the errorCode.
	 *
	 * @param params
	 *           the parameters provided by user for get the notify
	 * @param errorCode
	 *           the parameters provided by user for set notifyError errorCode
	 * @return a HashMap of the notify error
	 */
	...
	/**
	 * Get the notify of the params and the tradeStatus.
	 *
	 * @param params
	 *           the parameters provided by user to get the returnParams
	 * @param tradeStatus
	 *           the parameters provided by user to set notify trade_status
	 * @return the HashMap of the return Params
	 */
	...
	/**
	 * Get the notify of the params and the errorCode.
	 *
	 * @param params
	 *           the parameters provided by user to get the notify
	 * @param errorCode
	 *           the parameters provided by user to set notify detail
	 * @return the HashMap of the Refund Notify
	 ...
	 *
	 * @param params
	 *           the parameters provided by user to get the result
	 * @return the result string of the Payment
	 */
	 ...
	 *
	 * @param Params
	 *           the parameters provided by user to get Sign
	 * @return the Alipay sign
	 */
	 ...
	 *
	 * @param params
	 *           the parameters provided by user to remove the CSRFToken
	 * @return the params
	 */
	...
	/**
	 * mocked handling of notify request
	 *
	...
	/**
	 * mocked handling of Refund request
	 *
	 * @param unifyResponseMap
	 *           the mocked response from alipay
	 * @return order code
	...
	/**
	 * mocked handling of Notify Error request
	 *
	 * @param responseMap
	 *           the mocked response from alipay
	 */
	...
	/**
	 * mocked handling of publish submit order event
	 *
	 * @param orderCode
