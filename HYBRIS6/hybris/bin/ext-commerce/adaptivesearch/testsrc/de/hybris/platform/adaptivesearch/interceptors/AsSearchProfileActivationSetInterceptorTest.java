...
@IntegrationTest
public class AsSearchProfileActivationSetInterceptorTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/adaptivesearch/test/interceptors/asSearchProfileActivationSetInterceptorTest.impex", CharEncoding.UTF_8);
	}
