...
@IntegrationTest
public class AsSearchProfileInterceptorTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/adaptivesearch/test/interceptors/asSearchProfileInterceptorTest.impex", CharEncoding.UTF_8);
	}
