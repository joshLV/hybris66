...
public class MockAsSearchProvider implements AsSearchProvider, InitializingBean
{
	...
	@Override
	public AsSearchResultData search(final AsSearchProfileContext searchProfileContext, final String searchText,
			final int activePage, final int pageSize) throws AsException
	{
