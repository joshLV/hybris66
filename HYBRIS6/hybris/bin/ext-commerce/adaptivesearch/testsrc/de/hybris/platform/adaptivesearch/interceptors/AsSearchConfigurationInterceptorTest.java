...
@IntegrationTest
public class AsSearchConfigurationInterceptorTest extends ServicelayerTest
{
	...
	{
		importCsv("/adaptivesearch/test/interceptors/asSearchConfigurationInterceptorTest.impex", CharEncoding.UTF_8);
	}
