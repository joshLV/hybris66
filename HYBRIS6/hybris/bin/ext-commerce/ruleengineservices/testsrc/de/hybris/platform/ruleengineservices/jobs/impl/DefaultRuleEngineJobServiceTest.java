...
public class DefaultRuleEngineJobServiceTest extends ServicelayerTest
{
	...
	@Test
	public void testIsRunningTrue() throws Exception
	{
	...
	@Test
	public void testRunCronJobIfAllowedNoSupplier() throws Exception
	{
		assertThatThrownBy(() -> ruleEngineJobService.runCronJobIfAllowed(JOB_CODE, JOB_PERFORMABLE_BEAN_NAME, null))
	...
	public void testRunCronJobIfAllowedOk() throws Exception
	{
		...
		final Supplier<RuleEngineCronJobModel> ruleEngineCronJobSupplier = () -> ruleEngineJobService
				.runCronJobIfAllowed(JOB_CODE, JOB_PERFORMABLE_BEAN_NAME, () -> {
