...
public class DefaultRuleCompilerServiceTest
{
	...
	public void setUp() throws Exception
	{
		...
		when(ruleCompilerContextFactory.createContext(ruleCompilationContext, rule, MODULE_NAME, variablesGenerator)).thenReturn(context);
	...
	public void testCompileFails()
	{
		...
		assertThat(ruleCompilerResult.getResult()).isEqualTo(RuleCompilerResult.Result.ERROR);
		assertThat(ruleCompilerResult.getProblems()).isNotEmpty();
	}
}
