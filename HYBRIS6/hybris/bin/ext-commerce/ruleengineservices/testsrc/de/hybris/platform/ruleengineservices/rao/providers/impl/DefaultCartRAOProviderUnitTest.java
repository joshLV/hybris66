...
public class DefaultCartRAOProviderUnitTest
{
	...
	public void testExpandFactModelWithCartModel()
	{
		...
		final OrderConsumedRAO orderConsumedRAO = new OrderConsumedRAO();
		orderConsumedRAO.setCart(cartRAO);
		orderConsumedRAO.setAvailableQuantity(1);
		assertThat(facts).isNotEmpty().containsOnly(cartRAO, cartContext.getPaymentModeRAO(), orderConsumedRAO);
	}
