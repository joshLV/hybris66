...
public class WarehousingConsignmentWorkflowServiceTest
{
	...
	public void shouldStartConsignmentWorkflow()
	{
		...
		DefaultWarehousingConsignmentWorkflowService test = (DefaultWarehousingConsignmentWorkflowService) warehousingConsignmentWorkflowService;
		((DefaultWarehousingConsignmentWorkflowService) warehousingConsignmentWorkflowService).getLOGGER();
		//then
